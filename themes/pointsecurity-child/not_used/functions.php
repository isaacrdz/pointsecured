...
function nectar_main_styles() {	
		 ...
		 wp_register_style("custom-styles", get_stylesheet_directory_uri() . "/custom.css?v=1", '', '5.5.4');
...
if(function_exists('register_sidebar')) {
	...
	register_sidebar(array('name' => 'Top Area', 'id' => 'top-area', 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget'  => '</div>', 'before_title'  => '<h4>', 'after_title'   => '</h4>'));
	
	register_sidebar(array('name' => 'Footer Top', 'id' => 'footer-top', 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget'  => '</div>', 'before_title'  => '<h4>', 'after_title'   => '</h4>'));
