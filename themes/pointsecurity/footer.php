...
<div id="call-to-action">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col span_8 guarantee-content">
				<h2> <?php echo $options['cta-text']; ?> </h2>
				<small>*Subject to identical product offering.</small>
				
				<a class="nectar-button <?php if($cta_btn_color != 'see-through') echo 'regular-button medium '; ?> <?php echo $cta_btn_color;?>" data-color-override="false" href="<?php echo $cta_link ?>"><?php if(!empty($options['cta-btn'])) echo $options['cta-btn']; ?> </a>
			</div>
			
			<div class="col span_4 point-truck">
				<img src="<?php bloginfo('template_url'); ?>/img/point-transit.png" alt="Point Truck" />
			</div>
		</div>
...
<div id="footer-outer" data-using-widget-area="<?php echo $using_footer_widget_area; ?>">
	...
	<div id="footer-widgets" class="section-ads">
