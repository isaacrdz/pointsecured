...
/***************** Caroufredsel ******************/
	...
	function standardCarouselInit() {
		$('.carousel:not(".clients")').each(function(){
	    	var $that = $(this); 
	    	var maxCols = ($(this).parents('.carousel-wrap').attr('data-full-width') == 'true') ? 'auto' : 5 ;
...
$('body').on('click','.testimonial_slider .controls li', function(){
	...
	$(this).parents('.testimonial_slider').find('.slides blockquote').stop().css({'opacity':'0', 'left':'0px', 'z-index': '1'});
...
/*-------------------------------------------------------------------------*/
		...
		$('.equipment-specs h3').click(function(){
			$(this).next().slideToggle();
		});
		$('.equipment-specs').siblings('.img-with-aniamtion-wrap').click(function(){
			$(this).siblings('.equipment-specs').find('p').slideToggle();
		});
		$('.equipment-specs').siblings('.img-with-aniamtion-wrap').addClass('cursor');
		
		/*
if ($(window).width() < 1000) {
			$('.top-area').detach().appendTo('#mobile-menu');
		}
